...
// Build the capability block this node advertises. Detection fills config gaps.
...
int main(int argc, char** argv) {
    ...
    MM_INFO("Node vLLM path: {} (auto-provision {})",
    ...
    // Advertise cluster capabilities for multi-node vLLM planning.
    {
